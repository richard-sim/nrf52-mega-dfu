...
{
   uint32_t bootloader_addr = 0x74000;//NRF_UICR->NRFFW[0];	// NOTE: Hard-coded to the lowest-possible bootloader address supported, so it doesn't get obliterated when we copy the new bootloader in place

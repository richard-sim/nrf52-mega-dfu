...
#define DEVICE_NAME                          "HaloDfu"                                               /**< Name of device. Will be included in the advertising data. */
#define MANUFACTURER_NAME                    "Proxxi Technology"                                     /**< Manufacturer. Will be passed to Device Information Service. */

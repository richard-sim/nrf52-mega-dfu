...
extern const uint32_t _binary__mnt_c_dev_proxxi_halo_megadfu_finalize__build_megadfu_finalize_bin_start;
extern const uint32_t _binary__mnt_c_dev_proxxi_halo_megadfu_finalize__build_megadfu_finalize_bin_end;
...
//	}
	...
	unsigned char* pFinalizeStart = (unsigned char*)&_binary__mnt_c_dev_proxxi_halo_megadfu_finalize__build_megadfu_finalize_bin_start;
	unsigned char* pFinalizeEnd = (unsigned char*)&_binary__mnt_c_dev_proxxi_halo_megadfu_finalize__build_megadfu_finalize_bin_end;
	...
	prx_nvmc_write_word((uint32_t)&(NRF_UICR->CUSTOMER[22]), (uint32_t)&_binary__build_obj_payload_descriptor_bin_start);
	prx_nvmc_write_word((uint32_t)&(NRF_UICR->CUSTOMER[23]), (uint32_t)&_binary__build_obj_payload_descriptor_bin_end);
	prx_nvmc_write_word((uint32_t)&(NRF_UICR->CUSTOMER[24]), (uint32_t)&_binary__build_obj_payload_softdevice_lz4_start);
	prx_nvmc_write_word((uint32_t)&(NRF_UICR->CUSTOMER[25]), (uint32_t)&_binary__build_obj_payload_softdevice_lz4_end);
	prx_nvmc_write_word((uint32_t)&(NRF_UICR->CUSTOMER[26]), (uint32_t)&_binary__build_obj_payload_bootloader_lz4_start);
	prx_nvmc_write_word((uint32_t)&(NRF_UICR->CUSTOMER[27]), (uint32_t)&_binary__build_obj_payload_bootloader_lz4_end);
	prx_nvmc_write_word((uint32_t)&(NRF_UICR->CUSTOMER[28]), (uint32_t)&_binary__build_obj_payload_settings_lz4_start);
	prx_nvmc_write_word((uint32_t)&(NRF_UICR->CUSTOMER[29]), (uint32_t)&_binary__build_obj_payload_settings_lz4_end);
